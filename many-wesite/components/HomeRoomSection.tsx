    ...
    <section className="py-28 bg-[#F3F4F4]">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <div className="w-20 h-0.75 bg-[#5F9598] mx-auto mt-6 " />
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {rooms.map((room, index) => (
            ...
            >   
              ...
              {/* Image */}
              <div
                className="h-110 bg-cover bg-center transition duration-700 group-hover:scale-110"
                style={{ backgroundImage: `url(${room.image})` }}
              />

              {/* Dark Gradient */}
              <div className="absolute inset-0 bg-linear-to-t from-[#061E29]/90 via-[#061E29]/30 to-transparent" />
              ...
              <div className="absolute bottom-0 w-full p-6 text-white">
                ...
                <div className="opacity-0 translate-y-6 group-hover:opacity-100 group-hover:translate-y-0 transition duration-500">
                  ...
                  <button className="bg-[#1D546D] px-5 py-2 rounded-full text-sm hover:bg-[#5F9598] transition">
                    View Details
                  </button>
