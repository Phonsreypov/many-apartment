      ...
      <div className="relative max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="grid gap-14 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="hover:text-[#5F9598] cursor-pointer transition">Rooms</li>
              <li className="hover:text-[#5F9598] cursor-pointer transition">Gallery</li>
              <li className="hover:text-[#5F9598] cursor-pointer transition">Events</li>
              <li className="hover:text-[#5F9598] cursor-pointer transition">Blog</li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 mt-16 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400 gap-4">
          ...
          <div className="flex gap-6">
            <span className="hover:text-[#5F9598] cursor-pointer transition">Privacy</span>
            <span className="hover:text-[#5F9598] cursor-pointer transition">Terms</span>
            <span className="hover:text-[#5F9598] cursor-pointer transition">Policy</span>
          </div>
